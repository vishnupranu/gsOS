export type AIProvider = 'openai' | 'anthropic' | 'gemini' | 'deepseek' | 'qwen' | 'openrouter' | 'ollama';
...
export declare class AIProviderError extends Error {
    ...
    isRetryable: boolean;
    constructor(message: string, provider: AIProvider, statusCode?: number | undefined, isRetryable?: boolean);
}
export declare class AIGatewayError extends Error {
    errors: AIProviderError[];
    attempts: AIProvider[];
    constructor(message: string, errors: AIProviderError[], attempts: AIProvider[]);
}
